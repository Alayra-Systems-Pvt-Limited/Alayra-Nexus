...
function enterDemoMode() {
  ...
  document.getElementById('models-list').innerHTML =
    `<div class="model-card"><div class="model-card-info"><div style="display:flex;align-items:center;gap:8px;margin-bottom:2px"><span class="model-name">Claude 3.5 Sonnet</span><span class="badge badge-yellow">premium</span><span style="font-size:12px;font-weight:500;color:var(--green)">active</span><span style="font-size:11px;color:var(--subtle)">Priority 1</span></div><div class="model-string">claude-3-5-sonnet-20241022</div><div style="display:flex;align-items:center;gap:8px"><div class="model-caps"><span class="cap-badge active">Chat</span><span class="cap-badge" style="opacity:.7">Vision</span><span class="cap-badge" style="opacity:.7">Tools</span></div><span style="font-size:11px;color:var(--muted)">$3.00 / $15.00 per 1M</span><span style="font-size:11px;color:var(--muted)">200K ctx</span></div></div><div class="model-card-actions"><button class="btn-icon btn-sm">Edit</button><button class="btn-warning btn-sm">Pause</button><button class="btn-danger btn-sm">Delete</button></div></div>` +
    `<div class="model-card"><div class="model-card-info"><div style="display:flex;align-items:center;gap:8px;margin-bottom:2px"><span class="model-name">Gemini 2.0 Flash</span><span class="badge badge-purple">standard</span><span style="font-size:12px;font-weight:500;color:var(--green)">active</span><span style="font-size:11px;color:var(--subtle)">Priority 2</span></div><div class="model-string">gemini-2.0-flash</div><div style="display:flex;align-items:center;gap:8px"><div class="model-caps"><span class="cap-badge active">Chat</span><span class="cap-badge" style="opacity:.7">Vision</span><span class="cap-badge" style="opacity:.7">Tools</span></div><span style="font-size:11px;color:var(--muted)">$0.10 / $0.40 per 1M</span><span style="font-size:11px;color:var(--muted)">1M ctx</span></div></div><div class="model-card-actions"><button class="btn-icon btn-sm">Edit</button><button class="btn-warning btn-sm">Pause</button><button class="btn-danger btn-sm">Delete</button></div></div>` +
    `<div class="model-card"><div class="model-card-info"><div style="display:flex;align-items:center;gap:8px;margin-bottom:2px"><span class="model-name">Llama 3.3 70B</span><span class="badge badge-green">fast</span><span style="font-size:12px;font-weight:500;color:var(--yellow)">paused</span><span style="font-size:11px;color:var(--subtle)">Priority 3</span></div><div class="model-string">llama-3.3-70b-versatile</div><div style="display:flex;align-items:center;gap:8px"><div class="model-caps"><span class="cap-badge active">Chat</span></div><span style="font-size:11px;color:var(--muted)">$0.00 / $0.00 per 1M</span><span style="font-size:11px;color:var(--muted)">128K ctx</span></div></div><div class="model-card-actions"><button class="btn-icon btn-sm">Edit</button><button class="btn-secondary btn-sm">Activate</button><button class="btn-danger btn-sm">Delete</button></div></div>`;
